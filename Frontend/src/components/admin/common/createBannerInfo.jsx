...
export default function CreateBannerInfo(props) {
    ...
    const update = (user) => {
        const route = ApiRoutes.admin.banners.create;
    ...
    <Button variant="contained" color="success" size="large" sx={{marginRight: '1rem'}} disabled={selectedFiles <= 0} onClick={() => {
        update(user);
    }}>Save</Button>
